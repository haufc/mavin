...
<div class="content" <@studio.iceAttr component=contentModel/>>
    ...
    <div class="content__details container">
            ...
            <div class="row">    
            <i class="fas fa-minus text-white" style="padding-top:5px;"></i><li style="list-style-type: none; padding-left:10px;"><p class="text-white" style="font-size:14pt; font-weight:bold;">${group.groupContent_s}</p></li>    
            </div>
            </#list>
            </ol>
            <div class="row">
            <i class="fas fa-play text--red" style="padding-top: 5px;"></i><p class="text-white" style="padding-left:10px; font-size:14pt; font-weight:bold;">${contentModel.carouselTitle_t}</p>
            </div>
