                    ...
                    <div class="card" style="width: 100%; border: none; border-radius: unset;">
                      ...
                      <#if element.colortext_s == '1'>
                        	<div class="card-body text-white" style="background-color: #CE181F;">
                                 <a class="text-white" href="${element.urlpage_s}"><h4 class="card-text text--uppercase product-title-vie">${element.title_s}</h4></a>
                                 <a class="text-white" href="${element.urlpage_s}"><h4 class="card-text text--uppercase product-title-en" >${element.titleEN_s}</h4></a>
                            </div>
                    	<#else>
