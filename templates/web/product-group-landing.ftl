        ...
        $(document).ready(function(){
            ...
            if (url.indexOf('/en') > -1) {
                ...
                for(let i = 0; i < groupProductSize; i++) {
                    ...
                    $('.group-pr-'+i+' .paginate ul').find('li').attr('id', 'paig-item-'+i);
                    ...
                    $('.group-pr-' + i + ' .paginate #pagi-'+i).append("<li id='next-page' class='page-item'><a class='page-link' href='javascript:void(0)'><span class='fas fa-angle-right'></a></li>");
