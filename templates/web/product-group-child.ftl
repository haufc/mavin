          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-6 mb-5">
                <div class="card" style="width: 100%; border: none; border-radius: unset;">
                  ...
                  <div class="card-body text-white" style="background-color: #CE181F;position: absolute;top: 280px; width: 100%;">
                    <p class="card-text text--uppercase">${contentModel.productchildtitle_s}</p>
                  </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-6 mb-5" >
