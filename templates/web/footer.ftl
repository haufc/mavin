        ...
        <div class="footer__social-btns mb-3">
          <div class="footer__btns">
            <#if (contentModel.socialMedia_o.item)??>
                ...
                <a href="${media.url_s}" class="btn rounded-0" style="border: 1px solid #ddd; background: #fff; color: #00579d; width: 46px; height: 47px;">
                    <i class="fab ${media.icon_s}" style="font-size:30px;"></i>
                </a>
                </#list>
            </#if>
          </div> 
