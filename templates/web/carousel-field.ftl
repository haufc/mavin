<#import "/templates/system/common/cstudio-support.ftl" as studio />
        ...
        <div class="carousel slide" data-ride="carousel" id="expSlide" <@studio.iceAttr component=contentModel/>>
            ...
            <div class="carousel-inner">
                <div class="row">
                    <i class="fas fa-play text--red" style="padding-top: 5px;"></i><p class="text-white" style="padding-left:10px; font-size:14pt; font-weight:bold;">${contentModel.title_s}</p>
                </div>
