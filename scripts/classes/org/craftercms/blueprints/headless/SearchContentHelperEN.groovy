...
class SearchContentHelper {
    ...
    static final String NEWS_CONTENT_TYPE_QUERY = "content-type:\"/page/pagenewsdetailen\""
    ...
    static final String[] PRODUCTS_HIGHLIGHT_FIELDS = ["productnameEnglish_s", "productdescriptionEnglish_html"]
    ...
    def searchProducts(String userTerm, start = DEFAULT_START, rows = DEFAULT_ROWS) {
        ...
        if (userTerm) {
            ...
            def userTermQuery = "(productnameEnglish_s:(${userTerm}) OR productdescriptionEnglish_html:(${userTerm}))"
            q = "${q} AND ${userTermQuery}"
        }
